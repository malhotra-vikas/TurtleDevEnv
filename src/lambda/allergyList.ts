...
export async function allergyListHandler(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
  ...
  const allergies = [
    ...
    { name: 'Milk', type: 'Food', description: 'Lactose intolerance or milk protein allergy' },
    ...
    { name: 'Meat', type: 'Food', description: 'Rare allergy to red meat like beef, lamb, or pork' },
