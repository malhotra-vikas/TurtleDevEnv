...
export async function updateUserSubscription(email: string, name: string, subscriptionStatus: string, subscriptionDate: string, userCredits: string) {
  try {
    ...
    if (subscriptionStatus && subscriptionStatus.trim() !== '') {
      updateExpressionParts.push('#subscriptionStatus = :subscriptionStatus')
    ...
    if (subscriptionDate && subscriptionDate.trim() !== '') {
      updateExpressionParts.push('#subscriptionDate = :subscriptionDate')
      expressionAttributeNames['#subscriptionDate'] = 'subscriptionDate'
      expressionAttributeValues[':subscriptionDate'] = subscriptionDate
    }

    if (userCredits && userCredits.trim() !== '') {
      updateExpressionParts.push('#userCredits = :userCredits')
      expressionAttributeNames['#userCredits'] = 'userCredits'
      expressionAttributeValues[':userCredits'] = userCredits
    }
